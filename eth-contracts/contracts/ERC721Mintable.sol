...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != currentOwner, "The new address is already the owner");
        require(msg.sender == Owner() || isApprovedForAll( currentOwner, msg.sender), "Requester is neither owner nor authorized.");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != address(0) || !_exists(tokenId), "TokenId exists or invalid address");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require( from == _tokenOwner[tokenId], "From is not the owner of the token");
        require( to != address(0), "To is invalid address");
