...
async function main() {
   ...
   try{
        if (NFT_CONTRACT_ADDRESS) {
            ...
            const result = await nftContract.methods.mintNewNFT(OWNER_ADDRESS, Proof11.proof["a"], Proof11.proof["b"], Proof11.proof["c"], Proof11.inputs).send({ from: OWNER_ADDRESS });
