...
async function main() {
   ...
   try{
        if (NFT_CONTRACT_ADDRESS) {
            ...
            const result = await nftContract.methods.mintNewNFT(OWNER_ADDRESS, Proof10.proof["a"], Proof10.proof["b"], Proof10.proof["c"], Proof10.inputs).send({ from: OWNER_ADDRESS });
